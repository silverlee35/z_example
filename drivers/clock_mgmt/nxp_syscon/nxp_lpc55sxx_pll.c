...
const struct clock_mgmt_driver_api nxp_syscon_pll0_api = {
...
const struct clock_mgmt_driver_api nxp_syscon_pll1_api = {
	.get_rate = syscon_lpc55sxx_pll_get_rate,
	.configure = syscon_lpc55sxx_pll_configure,
#if defined(CONFIG_CLOCK_MGMT_RUNTIME)
	.notify = syscon_lpc55sxx_pll_notify,
...
const struct clock_mgmt_driver_api nxp_syscon_pdec_api = {
