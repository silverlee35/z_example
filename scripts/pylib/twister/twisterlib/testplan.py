...
class TestPlan:
    ...
    def find_twister_data(self, data_list, aliases):
        for data in data_list:
            if data.get('identifier') in aliases:
                return data
    ...
    def add_configurations(self):
        ...
        # FIXME: v1_boards and v2_dirs are not used
...
def change_skip_to_error_if_integration(options, instance):
    ...
    if instance.platform.name in instance.testsuite.integration_platforms:
        ...
        logger.info(f"Changing status of {instance.name} to ERROR because it is an integration platform")
