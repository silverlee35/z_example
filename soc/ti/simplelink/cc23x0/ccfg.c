...
const ccfg_t ccfg __attribute__((section(".ti_ccfg"))) __attribute__((used)) = {
	...
	.hwOpts = {CC23_CCFG_FLASH_PROP(ti_hw_opts_1), CC23_CCFG_FLASH_PROP(ti_hw_opts_2)},
	...
	.permissions.allowToolsClientMode =
		CC23_TO_PERM_VAL(CC23_CCFG_FLASH_PROP(ti_tools_client_mode)),
	...
	.misc.saciTimeoutOverride = CC23_CCFG_FLASH_PROP(ti_saci_timeout_override),
	.misc.saciTimeoutExp = CC23_CCFG_FLASH_PROP(ti_saci_timeout_exp),
